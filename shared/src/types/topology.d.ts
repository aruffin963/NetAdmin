...
export type DeviceType = 'router' | 'switch' | 'firewall' | 'server' | 'workstation' | 'printer' | 'access-point' | 'camera' | 'phone' | 'iot' | 'unknown';
export type DeviceStatus = 'online' | 'offline' | 'warning' | 'critical' | 'maintenance' | 'unknown';
export type PortType = 'ethernet' | 'fiber' | 'wifi' | 'serial' | 'usb' | 'other';
export type PortStatus = 'up' | 'down' | 'disabled' | 'testing' | 'unknown';
export type ConnectionType = 'wired' | 'wireless' | 'virtual' | 'tunnel' | 'trunk';
export type ConnectionStatus = 'active' | 'inactive' | 'error' | 'unknown';
export type DiscoveryMethod = 'ping' | 'arp' | 'snmp' | 'nmap' | 'cdp' | 'lldp' | 'ssh' | 'wmi';
